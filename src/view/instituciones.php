            ...
            <div class="card-body">
                <div class="page-title-box d-flex align-items-center justify-content-between p-0">
                    ...
                    <div class="page-title-right">
                        <a href="<?php echo BASE_URL; ?>nueva-institucion"
                            class="btn btn-primary waves-effect waves-light">+ Nuevo</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row col-12">
                    <div class="form-group row mb-3 col-6">
                        ...
                        <div class="col-7">
                            <input type="text" class="form-control" name="busqueda_tabla_codigo"
                                id="busqueda_tabla_codigo">
                        </div>
                    </div>
                    <div class="form-group row mb-3 col-6">
                    ...
                    <div class="form-group row mb-3 col-6">
                        ...
                        <div class="col-7">
                            <input type="text" class="form-control" name="busqueda_tabla_insti"
                                id="busqueda_tabla_insti">
                        </div>
                    </div>
                </div>
                <div class="form-group mb-0 text-center ">
                    <button type="button" class="btn btn-primary waves-effect waves-light"
                        onclick="numero_pagina(1);"><i class="fa fa-search"></i> Buscar</button>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                 <a href="<?php BASE_URL ?>imprimir-instituciones" class="btn btn-danger"><i class="fa fa-print"></i></a>
                
                <h4 class="card-title">Resultados de Búsqueda</h4>
                <div id="filtros_tabla_header"
                    class="form-group  row page-title-box d-flex align-items-center justify-content-between m-0 mb-1 p-0">
                    ...
                    <div>
                        ...
                        <select name="cantidad_mostrar" id="cantidad_mostrar" class="form-control-sm"
